...
| [Clean Archlinux with kde ](https://github.com/ErkkolaMaitohappo/arch-ps4-aur-smth-fork/releases/tag/v1.1.1%2Bkde)| Arch | [ErkkolaMaitohappo](https://github.com/ErkkolaMaitohappo)     | arch for ps4 but with kde plasma, sddm, firefox, dolphin filebrowser, pipewire and bluetooth. |
| [Clean Archlinux with xfce4 ](https://github.com/ErkkolaMaitohappo/arch-ps4-aur-smth-fork/releases/tag/v1.0.1%2Bxfce4)| Arch | [ErkkolaMaitohappo](https://github.com/ErkkolaMaitohappo)     | arch for ps4 but with xfce4, xfce4-goodies, sddm, firefox, pipewire and bluetooth. |
